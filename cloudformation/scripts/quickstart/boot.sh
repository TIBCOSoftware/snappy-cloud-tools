...
printf "https://github.com/SnappyDataInc/snappydata/releases/download/0.7/snappydata-0.7-bin.tar.gz" > snappydata-url.txt
printf "https://github.com/SnappyDataInc/zeppelin-interpreter/releases/download/0.7/snappydata-zeppelin-0.7.jar" > interpreter-url.txt
